...
<div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dashboard - Data Mahasiswa Nazi University</h1>
    <a href="{{ route('dashboard.generateReport') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Kelas Profesional
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Kelas Sistem Informasi
                                        </span>
                                    </div>
                                </div>
                            </div>
